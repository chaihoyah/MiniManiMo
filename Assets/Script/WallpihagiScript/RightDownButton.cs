...
public class RightDownButton : MonoBehaviour, IPointerUpHandler, IPointerDownHandler
{
    ...
    public virtual void OnPointerDown(PointerEventData ped)
    {
        if (!WallCount.isPressed)
        {
            ...
            foxAnim.SetBool("rightDown", true);
    ...
    public virtual void OnPointerUp(PointerEventData ped)
    {
        ...
        foxAnim.SetBool("rightDown", false);
