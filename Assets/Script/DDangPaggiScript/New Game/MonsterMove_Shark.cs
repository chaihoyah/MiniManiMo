...
public class MonsterMove_Shark : MonoBehaviour
{
    ...
    private MonsterRespawn MR1;
    public float dX, dY;

    void Awake()
    {
        PoolController = GameObject.Find("PoolAndCameraController");
        MR1 = PoolController.GetComponent<MonsterRespawn>();
    }
    ...
    IEnumerator Move()
    {
            ...
            this.transform.rotation = Quaternion.Euler(0, angle * (180 / Mathf.PI) - 90, 0);
            while (true)
            {
